class Truck_Tatra_Base extends CarScript
{
	void Truck_Tatra_Base()
	{
	...
	{
		return CarLightBase.Cast( ScriptedLightBase.CreateLight(Truck_TatraFrontLight) );
	}
	
	// Override for car-specific light type
	override CarRearLightBase CreateRearLight()
	{
		return CarRearLightBase.Cast( ScriptedLightBase.CreateLight(Truck_TatraRearLight) );
	}
	...
	override bool CrewCanGetThrough( int posIdx )
	{
		...
		{
			case 0:
				if ( GetCarDoorsState( "Truck_Tatra_Door_1_1" ) == CarDoorState.DOORS_CLOSED )
					return false;

				return true;
			
			case 1:
				if ( GetCarDoorsState( "Truck_Tatra_Door_2_1" ) == CarDoorState.DOORS_CLOSED )
					return false;
	...
	override string GetDoorInvSlotNameFromSeatPos(int posIdx)
	{
		...
		{
			case 0:
				return "Truck_Tatra_Door_1_1";
			break;
			case 1:
				return "Truck_Tatra_Door_2_1";
			break;
		}
