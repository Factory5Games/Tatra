...
{	
	...
	class Truck_Tatra_Base: Truck_01_Base
	{
		...
		hiddenSelectionsTextures[] = {"","","","","","","the_alliance_tatra\tatra\data\rama.paa","the_alliance_tatra\tatra\data\rama.paa","","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)","#(argb,8,8,3)color(0.521569,0.427451,0.054902,1.0,co)"};
		dashboardMatOn="THE_ALLIANCE_tatra\tatra\data\dash_lights_on.rvmat";
		dashboardMatOff="THE_ALLIANCE_tatra\tatra\data\dash_lights_off.rvmat";
		frontReflectorMatOn="THE_ALLIANCE_tatra\tatra\data\headlightson.rvmat";
		frontReflectorMatOff="THE_ALLIANCE_tatra\tatra\data\lightsoff.rvmat";
		brakeReflectorMatOn="THE_ALLIANCE_tatra\tatra\data\brakelightson.rvmat";
		brakeReflectorMatOff="THE_ALLIANCE_tatra\tatra\data\lightsoff.rvmat";
		ReverseReflectorMatOn="THE_ALLIANCE_tatra\tatra\data\headlightson.rvmat";
		ReverseReflectorMatOff="THE_ALLIANCE_tatra\tatra\data\lightsoff.rvmat";
		TailReflectorMatOn="THE_ALLIANCE_tatra\tatra\data\taillightson.rvmat";
		TailReflectorMatOff="THE_ALLIANCE_tatra\tatra\data\lightsoff.rvmat";
		fuelCapacity = 120;
		fuelConsumption = 30;
